...
public class OperationComb {
	...
	public String toString() {
		return "OperationComb [oid=" + oid + ", gsCode=" + gsCode + ", operationName=" + operationName
				+ ", operationInfo=" + operationInfo + ", operationTime=" + operationTime + ", person=" + person
				+ ", fedding=" + fedding + ", weight=" + weight + ", drinkWater=" + drinkWater + ", bodyTemperature="
				+ bodyTemperature + ", temperature=" + temperature + ", light=" + light + ", dust=" + dust
